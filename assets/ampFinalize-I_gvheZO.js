import{AmpSanitizeError as p,componentScripts as r,AMP_LIGHTBOX_ID as y,AMP_RUNTIME_SRC as d}from"./ampSanitize-DdJs1fRM.js";import{aT as o}from"./index-DvkmOkGJ.js";function h(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function b(t){const e=new TextEncoder().encode(t.styleSheet).length;if(e>o)throw new p(`<style amp-custom> is ${e} bytes, over the ${o}-byte AMP4EMAIL cap`);const l=t.settings.direction==="rtl"?"rtl":"ltr",s=t.settings.lang?` lang="${h(t.settings.lang)}"`:"",i=[...t.components],n=r(i),c=n.length>0?`
${n.join(`
`)}`:"",m=t.styleSheet!==""?`
